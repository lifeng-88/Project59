//
//  HubH5MediaCacheSchemeHandler.swift
//  App
//
...
final class HubH5MediaCacheSchemeHandler: NSObject, WKURLSchemeHandler {
    ...
    private func serve(_ urlSchemeTask: WKURLSchemeTask, taskID: ObjectIdentifier) {
        ...
        guard let requestURL = urlSchemeTask.request.url,
              ...
              let fileURL = HubH5MediaCacheManager.shared.cachedURL(for: remoteURLString, mediaType: mediaType),
