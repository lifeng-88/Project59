...
extension Notification.Name {
    static let hubH5PaymentTransactionUpdated = Notification.Name("hubH5PaymentTransactionUpdated")
}

@MainActor
final class HubH5PaymentManager {
    static let shared = HubH5PaymentManager()
