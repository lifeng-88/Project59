//
//  HubH5AppPaymentController.swift
//  App
//
...
final class HubH5AppPaymentController: UIViewController, WKNavigationDelegate {
    private let url: URL
    ...
    func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
        ...
        if HubH5PaymentRedirectReturnURL.matches(navigationURL) {
            didNotifyClose = true
            HubH5PaymentCallbackManager.shared.handle(url: navigationURL)
            dismiss(animated: true)
